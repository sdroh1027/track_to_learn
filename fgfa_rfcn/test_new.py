...
import mxnet as mx
from function.test_rcnn import test_rcnn_online_train
...
def main():
    ...
    test_rcnn_online_train(config, config.dataset.dataset, config.dataset.test_image_set, config.dataset.root_path, config.dataset.dataset_path, config.dataset.motion_iou_path,
